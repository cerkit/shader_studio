...
class ShaderRenderer: NSObject, ObservableObject {
    ...
    func compile(source: String) {
        ...
        do {
            ...
            guard let vertexFunction = library.makeFunction(name: "vertex_main"),
                ...
                self.compilationError = "Could not find 'fragment_main' function. Make sure your shader has a function named 'fragment_main'."
                return
            }
    ...
    func encode(commandBuffer: MTLCommandBuffer, texture: MTLTexture, time: Float, resolution: CGSize) {
